...
public class BuyerImpl implements Buyerdao {
	...
	try(Connection conn= DButil.provideConnection()){
	             ...
	             ps.setString(1, prop);
                  ...
                  while(rs.next()) {
               	   ...
               	   SellingList sl= new SellingList(itemId,property,price,quntity,sellingId,status);
                  list.add(sl);
	...
	public List<Buyerlist> viewBuyerList()
	    ...
	    PreparedStatement ps =conn.prepareStatement("select b.bid, b.name,b.email, s.property, s.price  "
	     ...
	     while(rs.next()) {
	    	...
	    	String buyname= rs.getString("name");
	    	 ...
	    	 Buyerlist by= new Buyerlist(buyId,buyname,buyemail,sprop,sprice);
	    	 list.add(by);
