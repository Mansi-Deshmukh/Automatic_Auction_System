...
public class Main {
    ...
    public static void printResults() {
        ...
        System.out.println("Eneter 1 :- For Admin Page ");
        ...
        case 1:
        	   ...
        	   String password=sc.next();
	        	...
	        	System.out.println("Welcome Admin...........");
	                System.out.println("Press 1 for View the registered Seller list");
					System.out.println("Press 2 for View the registered buyer list ");
        	      ...
        	      case 2:
        	    	       boolean a=true;
        	    	        while(a){
            	    	        ...
            	    	        boolean f=true;
            	    	        while(f) {
            	    	        	System.out.println("Want to add more property? Press 1" + "For Exit Press 0");
                	    	        int s=sc.nextInt();
                	    	        if(s==0) {
                	    	        	a=false;
                	    	        	f=false;
